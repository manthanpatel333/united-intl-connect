...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-brand-deep/90 backdrop-blur-md border-b border-brand-mid/30">
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-primary-foreground/80">
          <a href="#divisions" className="hover:text-brand-teal transition-colors">Divisions</a>
        ...
        <a
          href="#contact"
          className="hidden sm:inline-flex items-center gap-2 bg-brand-shimmer text-primary-foreground px-5 py-2.5 rounded-md text-sm font-semibold hover:opacity-90 transition-opacity"
        >
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <p className="text-brand-teal font-medium tracking-[0.3em] uppercase text-sm mb-6 animate-fade-up">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-display font-bold text-primary-foreground leading-tight mb-6 animate-fade-up" style={{ animationDelay: '0.15s' }}>
          ...
          <span className="text-gradient-brand">Connecting Markets.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up" style={{ animationDelay: '0.45s' }}>
          <a href="#divisions" className="bg-brand-shimmer text-primary-foreground px-8 py-3.5 rounded-md font-semibold text-base hover:opacity-90 transition-opacity">
            Our Divisions
          </a>
